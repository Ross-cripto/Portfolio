...
const Projects = () => {
  ...
  // Access projects directly since it's a top-level array in your translations
        ...
        {Array.isArray(projects) &&
          projects.map((project, index) => (
            <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
              ...
              >
                <img
                  // Usar la imagen importada correspondiente
              ...
              {project.url && (
                <a href={project.url} className="ml-2 hover:text-gray-200" target="_blank"
              ...
              {project.code && (
                <a href={project.code} className="ml-2 hover:text-gray-200"  target="_blank"
                rel="noopener noreferrer">
                  <FaGithub
                    className="text-blue-500 hover:text-blue-700"
                    style={{ fontSize: 15 }}
                ...
                {project.technologies?.map((tech, index) => (
                  <span key={index} className={`mr-2 rounded px-2 py-1 text-sm font-medium ${getColor(tech)}`}>
                    {tech}
                  </span>
                ))}
              </motion.div>
